...
$no_text= 'NO';
$form_id= 'form-id';
$slide_hint= 'Grab and slide to right to change state';
echo '
<style>
...
.grab-slider-field input {
  ...
  .grab-slider-wrapper {
    ...
    border-radius: calc('.$grab_height.' / 2);
    background-color: '.$yes_colr.';
    border-color: #a2a2a2;
  ...
  .grab-slider {
    ...
    top: 0;
    z-index: 2;
    height: calc('.$grab_height.' - 2px);
    /* width: calc('.$grab_height.' - 2px); * /
...
htm_Page_0( titl:'DEMO', hint:$©, info:'File: '.$DocFile.' - ver:'.$DocVer,inis:'',algn:'center', imag: $bodybg='../_accessories/_background.png', pbrd:true);
...
## Can not be used when variables are in lists: 'chck' 'rado' 'opti'
    ...
    $date= date("Y-m-d");
    htm_Card_0( capt:'The variants of Input / Output:', icon:'fas fa-info', hint:'', form:'', acti:'', clas:'cardW960', wdth:'640px', styl:'background-color: white;', attr:'',  show:true,  head:$headbg, help:'CustHelp.htm');
    htm_nl();
    htm_Fieldset_0(capt:'TEXT variants',icon:'',hint:'',wdth:'95%',marg:'',attr:'',rtrn:false);
        ...
        htm_Input(labl:'@htm_Input(html)', plho:'</>', icon:'', hint:'@Demo of htm_Input Field type html: Multi-line formatted html-text',     vrnt:'html', name:'html', valu:'',          form:'', wdth:'140px;',   algn:'left', attr:'', rtrn:false, unit:'', disa:false, rows:'3', step:'', list:[], llgn:'R', bord:'', ftop:''); 
        htm_nl();
        ...
        $text= '𝘓𝘐𝘊𝘌𝘕𝘚𝘌 & © 2019-2023 EV-soft';
        $html= '<a href="" border="0" style="cursor:help" rel="nofollow" title="'.$text.'"><img src=
                "https://chart.googleapis.com/chart?cht=qr&chl='.urlencode($text).'&chs=90x90&choe=UTF-8&chld=L|0"></a>';
        htm_Inbox(labl:'@htm_Inbox-demo',  plho:'', icon:'',hint:'@You can put anything html-code in htm_Inbox(). <br>Here it is a QR-code.',
                  vrnt:'',name:'Body_div',valu:$html,form:'',wdth:'120px;',algn:'center',
        ...
        htm_Inbox(labl:'@htm_Inbox-demo',  plho:'', icon:'',hint:'@You can put anything in htm_Inbox(). <br>Here it is a Code128 barcode.',
                  vrnt:'',name:'Body_div',valu:$html, form:'',wdth:'340px;',algn:'center',
                  attr:'color: green;',rtrn:false,unit:'',disa:false,rows:'2',step:'',list:[],llgn:'R',bord:'1px solid var(--grayColor);',ftop:'');
        htm_nl(2);
    ...
    htm_Fieldset_00();
    htm_nl(2);
    htm_Fieldset_0(capt:'NUMBER variants',icon:'',hint:'',wdth:'95%',marg:'',attr:'',rtrn:false);
        ...
        htm_Input(labl:'@htm_Input(Dec1)', plho:'', icon:'', hint:'@Demo of htm_Input Field type dec1: number with 1 decimal ',             vrnt:'dec1', name:'dec1', valu:$dec1='9999', form:'', wdth:'160px', algn:'left',   attr:'', rtrn:false, unit:'<Unit ');
        htm_Input(labl:'@htm_Input(Dec2)', plho:'', icon:'', hint:'@Demo of htm_Input Field type dec2: number with 2 decimal',              vrnt:'dec2', name:'dec2', valu:$dec2='9999', form:'', wdth:'160px', algn:'center', attr:'', rtrn:false, unit:' Unit ');
        htm_nl(2);
    ...
    htm_Fieldset_00();
    htm_nl(2);
    htm_Fieldset_0(capt:'OTHER variants',icon:'',hint:'',wdth:'95%',marg:'',attr:'',rtrn:false);
    ...
    htm_Card_0(capt:'@Example of htm_Table():', icon:'fas fa-info', hint:'', form:'', acti:'', clas:'cardW960', wdth:'640px', styl:'background-color: white;', attr:'',  show: true,  head: $headbg, help:'CustHelp.htm');           
    htm_Table(
...
",true)));
    ...
    htm_Card_0( capt:'@PHP Source-code: htm_Field_0_0();', icon:'fas fa-code', hint:'@HINT for this card', form:'', acti:'', clas:'cardW480', wdth:'640px', styl:'background-color: lightgray;', attr:'margin:0;', help:'CustHelp.htm');
...
htm_Fieldset_0(capt:'@Caption: ',
    ...
    // htm_Fieldset_0() must be followed by htm_Fieldset_00() after the content !               
STRING
;
    ...
    htm_Card_0( capt:'@PHP Source-code: htm_Field_0_00();', icon:'fas fa-code', hint:'', form:'', acti:'', clas:'cardW560', wdth:'640px', styl:'background-color: lightgray;', attr:'', help:'CustHelp.htm');
...
; 
    ...
    htm_Card_00();
        ...
        htm_nl(2);
    htm_Card_00(labl:'Demo',    icon:'', hint:'Buttom', name:'', form:'',     subm:false, attr:'', akey:'',  kind:'goon', simu:false);
        htm_nl(2);
    echo 'Examples of foldable card-system:';  htm_nl(2);
    htm_Card_0(capt:'@htm_Card_0(W= 560px) (click to close/open)', icon:'fas fa-database', hint:'', form:'head2', acti:'', clas:'cardW560', wdth:'640px', styl:'background-color: lightcyan;', attr:'',  show: true,  head: $headbg, help:'CustHelp.htm');           
        /* htm_nl(1); */
        htm_TextDiv(body:'Cards are used to display a collection of html-objects.<br>
              They are defined i 14 widths from 160 px to 1200 px and width 100%.<br>
    ...
    htm_Card_0(capt:'@Signup: <small>(Example)</small>', icon:'fas fa-user-check', hint:'', form:'head1', acti:'', clas:'cardW240', wdth:'640px', styl:'background-color: lightcyan;', attr:'', help:'CustHelp.htm');
    ...
    htm_Card_00(labl:'Login',    icon:'', hint:'@Login with the given data', name:'butt', form:'head1',     subm:true, attr:'', akey:'',  kind:'navi', simu:false);
    
    htm_nl(2);
    htm_Card_0( capt:'@Contact info:', icon:'fas fa-pen-square', hint:'', form:'head2', acti:'', clas:'cardW480', wdth:'640', styl:'background-color: lightcyan;', attr:'', help:'CustHelp.htm');           
        $wdh= '100%';
        $m= ' padding:0; test:99; ';
        $m= '';
    ...
    htm_nl(4);
    htm_Card_0( capt:'@User rights:', icon:'fas fa-pen-square', hint:'@In this card, you see a DEMO of the Multi-state button', form:'head3', acti:'', clas:'cardW960', wdth:'640', styl:'background-color: white;', attr:'',  show: true,  head: $headbg, help:'CustHelp.htm');           
    ...
    htm_Card_00(labl:'Save changes',    icon:'', hint:'@Save data in this card', name:'', form:'head3',     subm:true, attr:'', akey:'s',  kind:'save', simu:false);

    htm_Card_0(capt:'@Popup menues:',icon:'fas fa-pen-square',hint:'@HINT for this card',form:'head4',acti:'',clas:'cardW800',wdth:'640',styl:'background-color: white;',attr:'', show: true, head: $headbg, help:'CustHelp.htm');           
        ...
        Pmnu_0($elem='left_click',capt:'Popup-Menu', wdth:'200px', icon:'fas fa-info',stck:'false',attr:'background-color:lightcyan;',cntx:false);
   ...
   /**/
    ...
    htm_Card_0(capt:'@Switch buttons: (working on it)',icon:'fas fa-pen-square',hint:'',form:'sw',acti:'',clas:'cardW800',wdth:'640',styl:'background-color: white;',attr:'');           
    ...
    htm_nl();
    htm_Card_00(labl:'', icon:'', hint:'', name:'', form:'sw', subm:false, attr:'', akey:'s',  kind:'save', simu:false);

    htm_Card_0(capt:'@Toggleable Tabs:',icon:'fas fa-pen-square',hint:'@HINT for this card',form:'tb',acti:'',clas:'cardW800',wdth:'640',styl:'background-color: white;',attr:'', show: true, head: $headbg );           
    ...
    $strcards= 'cards is a container for html-objects.<br>
            It is build with two functions: htm_Card_0() and htm_Card_00()<br><br>
            ...
            Example: htm_Card_0(<abbr class= "hint"><data-hint>htm_Card_0($frmName=\'orders\', $capt=lang(\'@Find existing order:\'), $parms=\'\', $icon=\'fas fa-search\', $class=\'cardW720\', $where=__FILE__, $attr=\'\', $BookMark=\'blindAlley.page.php\',$panlBg=\'background-color: rgba(240, 240, 240, 0.80);\');</data-hint>Parameters</abbr>) and htm_Card_00(<abbr class= "hint"><data-hint>htm_Card_00($labl=\'@Save\', $subm=true, $title=\'\', $btnKind=\'save\', $akey=\'\', $simu=false, $frmName);</data-hint>Parameters</abbr>)
		';
    ...
    htm_Card_00(labl:'', icon:'', hint:'', name:'tb', form:'tb', subm:false, attr:'', akey:'s', kind:'save', simu:false);

     
    htm_Card_0(capt:'@Containers:',icon:'fas fa-info',hint:'@HINT for this card',form:'',acti:'',clas:'cardW800',wdth:'640',styl:'background-color: white;',attr:'', show: true, head: $headbg);           
    ...
    htm_Fieldset_00();
    htm_Card_00(labl:'', icon:'', hint:'', name:'', form:'tb', subm:false, attr:'', akey:'s',  kind:'save', simu:false);


    htm_Card_0(capt:'@Navigate functions:',icon:'fas fa-info',hint:'@HINT for this card',form:'',acti:'',clas:'cardW800',wdth:'640',styl:'background-color: white;',attr:'', show: true, head: $headbg);           
    ...
    htm_Card_0(capt:'@About function parameters:',icon:'fas fa-info',hint:'@HINT for this card',form:'head5',acti:'',clas:'cardW800',wdth:'640',styl:'background-color: white;',attr:'', show: true, head: $headbg);
