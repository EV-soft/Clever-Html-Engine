<?php   $DocFile= './Proj.demo/tinyEditor.page.php';    $DocVer='1.3.0';    $DocRev='2023-05-05';      $DocIni='evs';  $ModulNo=0; ## File informative only
...
htm_Page_0( titl:'HTML-editor - Introduction to the tiny Editor:',  hint:$©,  info:'File: '.$DocFile.' - Ver:'.$DocVer,  inis:'', algn:'center',  imag:'../_accessories/_background.png', pbrd:false);
    ...
    htm_Card_0( capt: '@Working with tiny Editor:', icon: 'fas fa-info', hint: '@HINT for this card', form: 'head6', acti: '', clas: 'cardWmax', wdth: '640', styl: 'background-color: white;', attr: '',  show : true,  head: $headbg, vhgh:'1200px');
        ...
        htm_textdiv('<b>Info:</b> This demo loads/saves data from file: EditContent.htm '.str_sp('8').
            htm_Input(labl:'Upload file',plho:'@Enter your filename here...',icon:'',hint:'@Upload file to EditContent.htm<br>Not working yet !',vrnt: 'file',
                      name:'ufile' ,valu:'',form:'',wdth:'220px',algn:'left',
                      attr:'', rtrn:true,unit:'',disa:false, rows:'', step:'',list:[],llgn:'R',bord:'',ftop:''). str_sp('4').
            htm_Input(labl:'Download file',plho:'@Enter your filename here...',icon:'',hint:'@Download EditContent.htm to a local file<br>Not working yet !',vrnt: 'butt',
            ...
            htm_textdiv('Alternative you can copy/paste from/to content in Sourc Code window.',styl:'white-space: nowrap;',rtrn:true)
