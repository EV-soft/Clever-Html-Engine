<?php   $DocFil= './Proj1/demoFile/support.page.php';    $DocVer='1.0.0';    $DocRev='2021-01-25';     $DocIni='evs';  $ModulNr=0; ## File informative only
...
htm_PagePrep($pageTitl='support.page.php', $ØPageImage=$ØProgRoot.'_assets/images/_background.png');
