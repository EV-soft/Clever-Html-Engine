<?   $DocFile='../Proj1/demoFile/Demo.page.php';    $DocVers='1.0.0';    $DocRev1='2020-07-20';     $DocIni='evs';  $ModulNo=0; ## File informative only
...
htm_PagePrep('DEMO', $ØPageImage='../_background.png',$align='center',$PgInfo=lang('@DEMO page'));
...
## Can not be used when variables are in lists: 'chck' 'rado' 'opti'
    ...
    htm_PanlHead($frmName='head', $capt='htm_PanlHead(W= 560px) (click to close/open)', $parms='', $icon='fas fa-database', $class='panelW560', $func='Undefined', $more='', 
        ...
        htm_nl(2);
        htm_Input($type='pass',$name='pass2',$valu='',$labl='@htm_Input(pass)',$hint='Demo of htm_Input Field type password with "hidden" output',          $plho='',        $width='95%',$algn='left',$unit='',$disa=false,$rows='3');
        htm_Input($type='mail',$name='mail1',$valu='',$labl='@htm_Input(mail)',$hint='Demo of htm_Input Field type mail with syntax control',               $plho='',        $width='95%',$algn='left',$unit='',$disa=false,$rows='3');
        htm_nl(4);
    ...
    htm_PanlHead($frmName='head2', $capt='@Contact info:', $parms='', $icon='fas fa-pen-square', $class='panelW240', $func='Undefined', $more='', 
        ...
        htm_Input($type='text',$name='name',$valu=$namex,$labl='@Name', $hint='',       $plho='@The name...', $wdth='',$algn='left',$unit='',$disa=false,$rows='3',$step='',$more=$m);
        htm_Input($type='text',$name='stre',$valu=$stre,$labl='@Street',$hint='',       $plho='@Address 1...',$wdth='',$algn='left',$unit='',$disa=false,$rows='3',$step='',$more=$m);
        htm_Input($type='text',$name='plac',$valu=$plac,$labl='@Place', $hint='',       $plho='@Address 2...',$wdth='',$algn='left',$unit='',$disa=false,$rows='3',$step='',$more=$m);
...
//    ['name5','private','@Details about private'],
//    ]);
        htm_Input($type='opti',$name='zipp',$valu=$zipp,$labl='@ZIP',   $hint='',       $plho='@Code...',     $wdth='31%',$algn='left',$unit='',$disa=false,$rows='3',$step='',$more=$m,$list= [
                    ['5000','5000','5000'],
                    ['6000','6000','6000'],
        ...
        htm_Input($type='text',$name='city',$valu=$city,$labl='@City', $hint='',                                                        $plho='@Address town...',$wdth='68%',$algn='left',$unit='',$disa=false,$rows='3',$step='',$more=$m);
        ...
        htm_Input($type='text',$name='coun',$valu=$coun,$labl='@Country',  $hint='',                                                    $plho='@Country...',     $wdth='',$algn='left',$unit='',$disa=false,$rows='3',$step='',$more=$m);
        htm_Input($type='area',$name='remk',$valu=$remk,$labl='@Remark',   $hint='@Demo of htm_Input Field type area: Multi-line text', $plho='@Remark?...',     $wdth='',$algn='left',$unit='',$disa=false,$rows='1',$step='',$more=$m);
        htm_Input($type='text',$name='phon',$valu=$phon,$labl='@Phone',    $hint='',                                                    $plho='@Phone number...',$wdth='',$algn='left',$unit='',$disa=false,$rows='3',$step='',$more=$m);
        htm_Input($type='text',$name='refe',$valu=$refe,$labl='@Reference',$hint='',                                                    $plho='@?...',           $wdth='',$algn='left',$unit='',$disa=false,$rows='3',$step='',$more=$m);
        htm_Input($type='mail',$name='mail3',$valu=$mail3,$labl='@Email',  $hint='@Demo of htm_Input Field type mail',                  $plho='@Email address...',$wdth='',$algn='left',$unit='',$disa=false,$rows='3',$step='',$more=$m);
