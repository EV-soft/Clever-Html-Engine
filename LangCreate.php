<?php  ## EV-soft - 2023-06-27  -  LangCreate.php
       ## Create / Update / Maintain list of translate strings by scanning the source-file(s)
       ## Place this file in the same folder as tinyfilemanager.php and open the file in your browser
    ...
    echo '<meta charset="utf-8">'.
         "<br><big>".'Projektscann: '."</big><br>".
         "<br>".'Scanning for prefix: "lng(\'" '." in .php/.htm files in current folder,".
         "<br>and create a complete list of language texts that you can translate".
         '<p style="font-family:courier; font-size:18; ">'; 
    $arrTrans= [];  $arrCode= [];
    ...
    echo '<br>Sorted list without duplicates for code: '.$compareCode.
         '<p style="font-family:courier; font-size:11; ">';
    '<pre>
{
...
echo ' <font color=red><- REMOVE THIS LAST COMMA !</font>
  ...
  echo '</p>'.
       '<br>Total: '.count($arrStrings).' strings i the sorted list. Longest string is on  '.$longest.' chars.'.
       '<br>You can copy - paste this list to your editor'.
       '<br><font color=red>Remember to escape the char: " </font>with a slash like this: \" if it occurs on translated text !'.
       '<br>Status of the analyzed language is '.round($miss / count($arrStrings) * 100).' % translated.';
?>