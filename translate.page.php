<?php   $DocFil= './translate.page.php';    $DocVer='1.1.0';    $DocRev='2021-11-01';     $DocIni='evs';  $ModulNr=0; ## File informative only
...
htm_PagePrep($pageTitl='translate.page.php', $ØPageImage='_accessories/_background.png');
    // Menu_Topdropdown(true); htm_nl(1);
    
    global $arrLang;
    // arrPrint($arrLang,'$arrLang');

    echo '<div style="text-align: center; background-image: url(\'_accessories/_background.png\');">';
    
    htm_PanlHead($frmName='', $capt='@About translate system:', $parms='', $icon='fas fa-info', $class='panelW560', $func='Undefined', $attr='', 
    ...
    htm_PanlHead($frmName='lang', $capt='@Select a language:', $parms='', $icon='fas fa-wrench', $class='panelW560', $func='Undefined', $attr='', 
                $BookMark='blindAlley.page.php',$panlBg='background-color: white;');
    echo '<div style="text-align: center; margin: 20px;">';  
    echo lang('The actual language is').'<b> '.$App_Conf['language'].' / '.($_SESSION['currLang']['native'] ?? '') .' </b><br><br>';
    # $type='',$name='',$valu='',$labl='',$hint='',$plho='@Enter...',$wdth='',$algn='left',$unit='',$disa=false,$rows='2',$step='',$attr='',$list=[],$llgn='R',$bord='',$proc=true);
    htm_Input($type='rado',$name='alllang',$valu=$alllang,$labl='@Filter',$hint='@Hide/show some (empty) languages in the language selector',$plho='Enter...',$wdth='110px',
              $algn='left',$unit='',$disa=true,$rows='2',$step='',$attr='onclick="this.form.submit();"',$list= [
    ...
    htm_Input($type='opti',$name='langu',$valu=$App_Conf['language'],$labl='@Select another language',$hint='@Select amongst installed languages',$plho='@Select...',$wdth='200px',
              $algn='left',$unit='',$disa=false,$rows='3',$step='',$attr='',$list= $SelList);
    echo '</div>';
    ...
    htm_PanlHead($frmName='', $capt='Translate language strings:', $parms='', $icon='fas fa-tools', $class='panelW960', $func='Undefined', $attr='', 
